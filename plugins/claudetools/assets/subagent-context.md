...
<available_tools>
### CLI Tools Available
- **srcpilot** (via Bash): `srcpilot <command>`
...
- ALWAYS use srcpilot CLI to navigate code before reading files directly
...
- **intercept-grep**: Redirects symbol-like Grep queries to srcpilot find-symbol; falls back to grep when pilot returns nothing
</guardrails>
