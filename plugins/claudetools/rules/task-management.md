...
- Use `/task-manager restore` to sync task display with persisted state.

### During work
- Use TaskCreate/TaskUpdate to manage tasks — the MCP task-system persists changes automatically.
