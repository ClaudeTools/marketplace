...
2. **Skills become available** — `/codebase-explorer`, `/debugger`, `/prompt-improver`, and 4 more respond to explicit invocation or trigger automatically based on intent
