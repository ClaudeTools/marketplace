<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="plugins/claudetools/assets/img/logo-dark.png">
    <img alt="claudetools" src="plugins/claudetools/assets/img/logo-light.png" width="380">
  </picture>
</p>
